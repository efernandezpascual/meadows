...
This repository stores all the information related to the manuscript *Seed germination ecology of European mesic grasslands*, including the raw datasets, the scripts to perform data cleaning and analysis, and the `Rmarkdown` files to create the manuscript.
