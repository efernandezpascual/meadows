...
This repository stores all the information related to the manuscript *Seed ecology of European mesic meadows: the domestication of plant regeneration strategies*, including the raw datasets, the scripts to perform data cleaning and analysis, and the `Rmarkdown` files to create the manuscript.
