...
This repository stores all the information related to the manuscript *Seed ecology of European mesic meadows*, including the raw datasets, the scripts to perform data cleaning and analysis, and the `Rmarkdown` files to create the manuscript.
...
* `data` Data files including the seed trait datasets (European, Iberian and Cantabrian) and the phylogenetic tree.
